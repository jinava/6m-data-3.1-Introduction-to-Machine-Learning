...
notebooks/
  ...
  05_knn_and_mini_nn.ipynb   ← 🟡 Optional deep-dive: KNN + mini neural net from scratch in NumPy (XOR, backprop)   # - [Opus 4.8] added
```
